...
def parse_args(parser):
    parser.add_argument('--dataset-loc1', type=str, default='./data/real', help='Location dataset 1')
    parser.add_argument('--dataset-loc2', type=str, default='./data/sketch', help='location dataset 2')
