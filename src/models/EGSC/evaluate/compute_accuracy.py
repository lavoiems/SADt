...
def parse_args(parser):
    ...
    parser.add_argument('--dataset-src', type=str, default='mnist', help='name of the src dataset')
    parser.add_argument('--dataset-trg', type=str, default='svhn',  help='name of the tgt dataset')
