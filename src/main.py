...
def parse_args():
    ...
    parser.add_argument('--iterations', type=int, default=100001, help='Total number of iterations for training')
    parser.add_argument('--evaluate', type=int, default=100, help='Number of iterations per evaluate')
